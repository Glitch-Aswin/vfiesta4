        ...
        <div className="md:hidden border-t bg-white">
          <div className="max-w-6xl mx-auto px-6 py-4">
            <ul className="flex flex-col gap-4 text-base font-medium text-gray-700 font-aderos">
              ...
              <li><a href="#speakers" onClick={() => setOpen(false)} className="block py-1">SPEAKERS</a></li>
              <li><a href="#schedule" onClick={() => setOpen(false)} className="block py-1">SCHEDULE</a></li>
